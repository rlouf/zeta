...
///
/// let hash = zeta::substrate::hash_bytes(b"hello wire");
...
impl Hash {
    ...
    ///
    /// ```
    /// let hash = zeta::substrate::hash_bytes(b"");
...
/// ```
/// let hash = zeta::substrate::hash_bytes(b"hello wire");
/// assert_eq!(hash, zeta::substrate::hash_bytes(b"hello wire"));
/// ```
...
/// use std::path::Path;
///
/// let hash = zeta::substrate::hash_file(Path::new("data.bin")).unwrap();
/// println!("{hash}");
/// ```
