...
def test_zeta_agent_step_does_not_insert_blank_lines_between_tool_calls(
    ...
    def fake_run_agent_turn(
        ...
        **kwargs: object,
        ...
        for draft in draft_events(events):
            event_sink(draft)
        return AgentRunResult(final_answer="Done.", events=draft_events(events))
...
""",
    ...
    def fake_run_agent_turn(
        ...
        **kwargs: object,
        ...
        captured["transcript"] = transcript
        captured["config"] = config
        return AgentRunResult(final_answer="answered")
...
def test_zeta_step_records_failed_turn_without_answer(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        zeta_runner,
        "run_agent_turn",
        lambda *args, **kwargs: AgentRunResult(events=[]),
    )
...
def test_zeta_step_records_aborted_turn_on_runtime_error(monkeypatch) -> None:
    def raise_runtime_error(*args, **kwargs) -> AgentRunResult:
...
def test_zeta_step_records_aborted_turn_on_keyboard_interrupt(monkeypatch) -> None:
    def raise_keyboard_interrupt(*args, **kwargs) -> AgentRunResult:
