...
from commas.display.state import TraceRenderState
from commas.display.summarize import short_trace_id, summarize, tool_result_summary
from commas.display.tty import muted, should_color
...
def transcript_assistant_block(
    ...
    if content:
        ...
        renderables.append(
            Panel(
                Markdown(content),
                title=Text("commas", style="bold magenta"),
                title_align="left",
