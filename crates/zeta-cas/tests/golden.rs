...
const GOLDEN_BYTES: &[u8] = b"zeta-cas golden pin: one hash universe\n";
const GOLDEN_BYTES_HEX: &str =
    "50c0700316fc0ef6fa6417200ed91526f247e7f4a19117e4907cf876fc3d6daf";
const GOLDEN_FILE_HEX: &str =
    "49e23e8f078ffc54755d6b1136c4247a6cf2bbb2013af2cc099e1374da9543a4";

#[test]
fn golden_bytes_digest_is_pinned() {
    let hash = zeta_cas::hash_bytes(GOLDEN_BYTES);
...
fn golden_file_digest_is_pinned_and_matches_hash_bytes() {
    ...
    let hash = zeta_cas::hash_file(&path).unwrap();
    assert_eq!(hash.to_hex(), GOLDEN_FILE_HEX);
    let bytes = std::fs::read(&path).unwrap();
    assert_eq!(zeta_cas::hash_bytes(&bytes), hash);
