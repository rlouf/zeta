...
harness. The cases pin schedule activation, ordinary authored occurrence
events, retry-stable scheduler decisions, catch-up status, and the scheduler
read model without introducing calendar policy into Dispatch.
