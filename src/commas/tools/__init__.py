"""Concrete Commas tool implementations."""

from __future__ import annotations

from typing import TYPE_CHECKING

from commas.tools import bash, edit, grep, ls, query_log, read, web, write
...
def builtin_capabilities() -> dict[str, RegisteredCapability]:
    return {
        ...
        "commas.query_log": builtin_capability(query_log.SPEC, query_log.run),
