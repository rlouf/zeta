"""Compact current-session status for shell-native Commas workflows."""
...
from commas.sessions import latest_active_failure, session_id
...
LOGGER = logging.getLogger("commas.status")
